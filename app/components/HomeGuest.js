  ...
  function ourReducer(draft, action) {
    switch (action.type) {
      ...
      case "usernameUniqueResults":
        if (action.value) {
          (draft.username.hasErrors = true), (draft.username.isUnique = false);
      ...
      case "emailAfterDelay":
        if (!/^\S+@\S+$/.test(draft.email.value) && !action.noRequest) {
          draft.email.hasErrors = true;
          draft.email.message = "You must enter a valid email.";
        }
